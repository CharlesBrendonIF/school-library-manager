...
public class AuthService {
    ...
    /**
     * Construtor que recebe um Scanner compartilhado, evitando conflitos
     * com outros componentes que também lêem System.in.
     *
     * @param scanner o Scanner centralizado da aplicação
     */
    ...
    public Usuario cadastro(Biblioteca b) {
        ...
        // Semestre é coletado conforme a tela de Cadastro definida no projeto,
        // mas não faz parte dos atributos da entidade Usuario — descartado após leitura.
        System.out.print("Semestre: ");
        scanner.nextLine(); // lido e descartado (não consta nos atributos de Usuario)
