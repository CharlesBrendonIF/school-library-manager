...
import br.edu.ifba.ed.FilaPrioridadeReserva;
...
public class Titulo {
    ...
    public Livro[] getExemplaresIndisponiveis(){
        return new Livro[0];
    }// Lista todos os exemplares deste do livro com este titulo que foram emprestados

    public Livro[] getExemplaresDisponiveis(){
        return new Livro[0];
    }// Lista todos os exemplares deste do livro que estão disponiveis
